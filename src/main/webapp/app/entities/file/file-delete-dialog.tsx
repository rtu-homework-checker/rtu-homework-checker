...
export const FileDeleteDialog = (props: IFileDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rtuHomeworkCheckerApp.file.delete.question">
        <Translate contentKey="rtuHomeworkCheckerApp.file.delete.question" interpolate={{ id: fileEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-file" color="danger" onClick={confirmDelete}>
