...
export const StudentDeleteDialog = (props: IStudentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rtuHomeworkCheckerApp.student.delete.question">
        <Translate contentKey="rtuHomeworkCheckerApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
