  ...
  return (
    <div>
      <h2 id="student-heading">
        <Translate contentKey="rtuHomeworkCheckerApp.student.home.title">Students</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="rtuHomeworkCheckerApp.student.home.createLabel">Create new Student</Translate>
        </Link>
      </h2>
        ...
        {studentList && studentList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('studentcode')}>
                  <Translate contentKey="rtuHomeworkCheckerApp.student.studentcode">Studentcode</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="rtuHomeworkCheckerApp.student.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('surname')}>
                  <Translate contentKey="rtuHomeworkCheckerApp.student.surname">Surname</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rtuHomeworkCheckerApp.student.home.notFound">No Students found</Translate>
            </div>
          )
        )}
      </div>
